 ...
 */
public class ComposantCfg extends Configuration {

    public ComposantCfg(String name, ArrayList<Composant> composant, ArrayList<Connecteur> connecteur, ArrayList<Port> port, ArrayList<Attachement> attachement, ArrayList<Binding> binding) {
